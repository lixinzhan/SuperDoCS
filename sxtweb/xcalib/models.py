...
class LOCALSTANDARD(models.Model):
    ...
    CalibrationDateTime = models.DateTimeField()
    CalibratedBy = models.CharField(max_length=32, verbose_name=_("Calibrated By"))
...
class CALIBRATION(models.Model):
    CalibrationId = models.CharField(max_length=32,unique=True)    
    Filter = models.ForeignKey(FILTER, on_delete=models.CASCADE)
    Cone = models.ForeignKey(CONE,verbose_name=_('Applicator'), on_delete=models.CASCADE)
    ...
    MeasurementDate = models.DateField(verbose_name=_("Measurement Date"))
...
class OUTPUTFACTOR(models.Model):
    OutputFactorId = models.CharField(max_length=32, unique=True)    
