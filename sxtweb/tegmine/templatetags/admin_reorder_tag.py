#
# This solution of admin app/model re-ordering is from http://djangosnippets.org/snippets/1939/
# with the part of "if not app_name" commented out for an KeyError raised.
#
# This is the version following the comment following it 
# for working with Django-1.4.
#
# Information from the original work is maintained as below.
